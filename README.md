...
I, Keven Denen, will participate in the next [Devember](https://devember.org/). 
My [Devember](https://devember.org/) will be learning Clojure. I promise I will 
program for my [Devember](https://devember.org/) for at least an hour, every day 
of the next December. I will also write a daily public devlog and will make the 
produced code publicly available on the internet (this repository). 
No matter what, I will keep my promise.

I will be using this [Devember](https://devember.org/) to learn Clojure. I will start 
off using the code in this repository, taken from [clojure koans](http://clojurekoans.com/)
as my guide. If I make it through all of these koans, I will persue other learning
tools. I will be hosting my devlog on [my blog](http://kevendenen.wordpress.com).
